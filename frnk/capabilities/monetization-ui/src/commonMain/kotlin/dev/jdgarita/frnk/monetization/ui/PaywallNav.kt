 ...
 * effect wiring, decoupled from any concrete route so a host can mount it against [ToolkitRoute.Paywall]
...
/**
 * Registers [FrnkPaywallDestination] at the toolkit-owned [ToolkitRoute.Paywall] in a Koin navigation
