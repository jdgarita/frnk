...
- `FirebaseAnalyticsTracker.kt` — analytics via Firebase Analytics (gitlive `firebase-analytics`). (`FirebaseAuthService` was deleted with `AuthService` in restructure Stage 2.)
