 ...
 * not fix. Home and Settings are owned by the scaffold (theme icon tokens + `FrnkRoute.Home` /
 * `FrnkRoute.Settings`); the host supplies this middle tab's:
 *  - [route] — its nested-graph root and the bar-tap target (a [FrnkRoute.Custom] or the host's own
