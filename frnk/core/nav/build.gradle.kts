...
kotlin {
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            // Type-safe nav routes (FrnkRoute is @Serializable). Core only — Navigation3 encodes
            ...
            // FrnkRoute's `: NavKey` supertype and the back-stack helpers are visible to consumers.
