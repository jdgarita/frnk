...
mapOf(
    ...
    "core-platform" to "frnk/core/platform",
    ...
    "analytics-posthog" to "frnk/capabilities/analytics-posthog",
    "crash-sentry" to "frnk/capabilities/crash-sentry",
    "remote-config-api" to "frnk/capabilities/remote-config-api",
    "remote-config-impl" to "frnk/capabilities/remote-config-impl",
    "identity-api" to "frnk/capabilities/identity-api",
    "identity-impl" to "frnk/capabilities/identity-impl",
