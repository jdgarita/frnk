...
class RoomIosDatabaseHelper : RoomDatabaseHelper() {
    ...
    override fun createDatabaseBuilder(): RoomDatabase.Builder<MyProjectRoomDatabase> = Room.databaseBuilder<MyProjectRoomDatabase>(name = documentDirectory() + "/" + getDatabaseFilename())
